...
class ApplyStockConditionToSelectWithDefaultStockTest extends TestCase
{
    ...
    /**
     * @magentoDataFixture Magento_InventoryCatalogSearch::Test/_files/clean_catalog_product_index_eav_table.php
     * @magentoDataFixture Magento_InventoryCatalogSearch::Test/_files/clean_cataloginventory_stock_status_table.php
