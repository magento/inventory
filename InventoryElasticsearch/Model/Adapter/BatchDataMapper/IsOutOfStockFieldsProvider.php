...
use Magento\InventoryElasticsearch\Model\ResourceModel\StockInventory;
use Magento\Framework\Exception\NoSuchEntityException;
use Magento\Store\Model\StoreManagerInterface;

/**
 * Provide data mapping for out of stock status fields
 */
class IsOutOfStockFieldsProvider implements AdditionalFieldsProviderInterface
{
    ...
    /**
     * Resolve out of stock status field name
     *
