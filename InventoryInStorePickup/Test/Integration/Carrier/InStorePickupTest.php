...
namespace Magento\InventoryInStorePickup\Test\Integration\Carrier;
...
class InStorePickupTest extends TestCase
{
     ...
     * @magentoConfigFixture store_for_eu_website_store carriers/in_store/active 1
     * @magentoConfigFixture store_for_eu_website_store carriers/in_store/price 5.95
     * @magentoConfigFixture store_for_eu_website_store carriers/in_store/handling_type F
     * @magentoConfigFixture store_for_eu_website_store carriers/in_store/handling_fee 1.05
     *
     * @magentoDbIsolation disabled
     */
    public function testShippingCostWithHandlingFeeFixed()
    {
        $searchCriteria = $this->searchCriteriaBuilder
            ->addFilter('reserved_order_id', 'in_store_pickup_test_order')
            ->create();
        ...
        $this->assertEquals("in_store_pickup", $cart->getShippingAddress()->getShippingMethod());
        $this->assertEquals(7.0, $cart->getShippingAddress()->getShippingAmount());
    }
     ...
     * @magentoConfigFixture store_for_eu_website_store carriers/in_store/active 1
     * @magentoConfigFixture store_for_eu_website_store carriers/in_store/price 5.95
     * @magentoConfigFixture store_for_eu_website_store carriers/in_store/handling_type P
     * @magentoConfigFixture store_for_eu_website_store carriers/in_store/handling_fee 20
     *
     * @magentoAppArea frontend
     *
     * @magentoDbIsolation disabled
     */
    public function testShippingCostWithHandlingFeePercent()
    {
        $searchCriteria = $this->searchCriteriaBuilder
            ->addFilter('reserved_order_id', 'in_store_pickup_test_order')
            ->create();
        ...
        $this->assertEquals("in_store_pickup", $cart->getShippingAddress()->getShippingMethod());
        $this->assertEquals(7.14, $cart->getShippingAddress()->getShippingAmount());
    }
