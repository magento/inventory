...
class PlaceOrderOnAdditionalStockTest extends AbstractBackendController
{
    ...
    protected function setUp(): void
    {
        ...
        $this->stockRepository = $this->_objectManager->get(StockRepositoryInterface::class);
        ...
        $this->getStockItemConfiguration = $this->_objectManager->get(GetStockItemConfigurationInterface::class);
        $this->saveStockItemConfiguration = $this->_objectManager->get(SaveStockItemConfigurationInterface::class);
