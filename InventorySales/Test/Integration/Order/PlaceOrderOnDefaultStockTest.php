...
class PlaceOrderOnDefaultStockTest extends TestCase
{
    ...
    /**
     * @magentoDataFixture Magento/InventoryApi::Test/_files/products.php
     * @magentoDataFixture Magento/InventoryCatalog::Test/_files/source_items_on_default_source.php
     * @magentoDataFixture Magento/InventorySalesApi::Test/_files/quote_two_carts.php
     * @magentoDataFixture Magento/InventoryIndexer::Test/_files/reindex_inventory.php
     * @magentoConfigFixture current_store cataloginventory/item_options/backorders 1
     */
