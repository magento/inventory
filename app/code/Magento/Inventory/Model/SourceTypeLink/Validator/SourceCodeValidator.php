 ...
 */
class SourceCodeValidator implements SourceTypeLinkValidatorInterface
{
    ...
    public function validate(SourceTypeLinkInterface $link): ValidationResult
    {
        ...
        $errors = [
            $this->notAnEmptyString->execute(SourceTypeLinkInterface::SOURCE_CODE, $value),
            $this->noWhitespaceInString->execute(SourceTypeLinkInterface::SOURCE_CODE, $value),
