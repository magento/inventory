...
class GetMinQtyConfigurationValue implements GetMinQtyConfigurationValueInterface
{
    /**
    ...
    {
        return (int)$this->getConfigurationValue->execute(StockItemConfigurationInterface::MIN_QTY);
    }
}
