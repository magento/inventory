...
use Magento\InventoryConfigurationApi\Api\GetMinSaleQtyConfigurationValueInterface;
use Magento\InventoryConfigurationApi\Api\StockItemConfigurationInterface;

class GetMinSaleQtyConfigurationValue implements GetMinSaleQtyConfigurationValueInterface
{
    /**
    ...
    {
        $result = $this->getConfigurationValue->execute(StockItemConfigurationInterface::MIN_SALE_QTY, $stockId);
        return (float)$result ?? $result;
    }
