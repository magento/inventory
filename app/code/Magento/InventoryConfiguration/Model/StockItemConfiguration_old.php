...
use Magento\InventoryConfigurationApi\Api\Data\StockItemConfigurationInterface_old;

/**
 * @inheritdoc
 */
class StockItemConfiguration_old implements StockItemConfigurationInterface_old
{
    /**
