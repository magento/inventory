...
/**
 * Adapt "manage stock" value for stock item configuration.
 */
class GetManageStockPlugin
{
    /**
     ...
     */
    public function aroundGetManageStock(StockItemInterface $subject, \Closure $proceed): bool
    {
        ...
        return $this->getInventoryConfiguration->isManageStock(
            $productSku,
