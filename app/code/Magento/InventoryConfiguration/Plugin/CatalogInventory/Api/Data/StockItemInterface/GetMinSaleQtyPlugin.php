...
class GetMinSaleQtyPlugin
{
     ...
     */
    public function aroundGetMinSaleQty(StockItemInterface $subject, \Closure $proceed): float
    {
        ...
        return $this->getInventoryConfiguration->getMinSaleQty(
            $productSku,
