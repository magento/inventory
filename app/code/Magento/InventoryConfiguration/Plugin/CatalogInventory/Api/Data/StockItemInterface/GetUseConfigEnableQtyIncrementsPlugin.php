...
/**
 * Adapt "use config enable quantity increments" value for stock item configuration.
 */
class GetUseConfigEnableQtyIncrementsPlugin
{
    /**
     ...
     */
    public function aroundGetUseConfigEnableQtyInc(StockItemInterface $subject, \Closure $proceed): bool
    {
