...
/**
 * Adapt "use config is decimal divided" value for stock item configuration.
 */
class GetUseConfigIsDecimalDividedPlugin
{
    /**
     ...
     */
    public function aroundGetUseConfigIsDecimalDivided(StockItemInterface $subject, \Closure $proceed): bool
    {
        ...
        return $stockItemConfiguration->isDecimalDivided() === null;
    }
}
