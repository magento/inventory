...
/**
 * Adapt "use config is quantity decimal" value for stock item configuration.
 */
class GetUseConfigIsQtyDecimalPlugin
{
    /**
     ...
     */
    public function aroundGetUseConfigIsQtyDecimal(StockItemInterface $subject, \Closure $proceed): bool
    {
