...
/**
 * Adapt "use config max sale qty" value for stock item configuration.
 */
class GetUseConfigMaxSaleQtyPlugin
{
    /**
     ...
     */
    public function aroundGetUseConfigMaxSaleQty(StockItemInterface $subject, \Closure $proceed): bool
    {
