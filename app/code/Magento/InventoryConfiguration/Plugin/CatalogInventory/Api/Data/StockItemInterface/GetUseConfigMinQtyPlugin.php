...
/**
 * Adapt "use config min qty" value for stock item configuration.
 */
class GetUseConfigMinQtyPlugin
{
    /**
     ...
     */
    public function aroundGetUseConfigMinQty(StockItemInterface $subject, \Closure $proceed): bool
    {
