...
/**
 * Adapt "use config min sale qty" value for stock item configuration.
 */
class GetUseConfigMinSaleQtyPlugin
{
    /**
     ...
     */
    public function aroundGetUseConfigMinSaleQty(StockItemInterface $subject, \Closure $proceed): bool
    {
