...
/**
 * Adapt "use config notify stock quantity" value for stock item configuration.
 */
class GetUseConfigNotifyStockQtyPlugin
{
    /**
     ...
     */
    public function aroundGetUseConfigNotifyStockQty(StockItemInterface $subject, \Closure $proceed): bool
    {
