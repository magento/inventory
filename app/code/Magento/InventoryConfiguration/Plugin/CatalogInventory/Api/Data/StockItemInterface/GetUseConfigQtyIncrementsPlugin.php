...
/**
 * Adapt "use config quantity increments" value for stock item configuration.
 */
class GetUseConfigQtyIncrementsPlugin
{
    /**
     ...
     */
    public function aroundGetUseConfigQtyIncrements(StockItemInterface $subject, \Closure $proceed): bool
    {
