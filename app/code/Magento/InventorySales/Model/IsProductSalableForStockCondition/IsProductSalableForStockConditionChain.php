 ...
 * @inheritdoc
 */
class IsProductSalableForStockConditionChain implements IsProductSalableForStockInterface
{
    /**
    ...
    private function validateConditions(array $conditions)
    {
        foreach ($conditions as $condition) {
            ...
            if (!$condition['object'] instanceof IsProductSalableForStockInterface) {
                throw new LocalizedException(
                    __(
                        'Condition have to implement %interface.',
                        ['interface' => IsProductSalableForStockInterface::class]
                    )
                );
            }
        }
